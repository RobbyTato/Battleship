...
def game():
    ...
    while True:
        ...
        if is_player_turn:
            ...
            logging.debug(shot)
            logging.debug(player.ship_board_to_string())
            logging.debug(player.shot_board_to_string())
            logging.debug(bot.ship_board_to_string())
            logging.debug(bot.shot_board_to_string())
            ...
            logging.debug(shot)
            logging.debug(player.ship_board)
            logging.debug(player.shot_board)
            logging.debug(bot.ship_board)
            logging.debug(bot.shot_board)
